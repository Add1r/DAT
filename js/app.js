(() => {
    ...
    const navigatorButton = document.querySelector(".navigation-button");
    const scrollChange = window.screen.height;
    const add_class_on_scroll = () => navigatorButton.classList.add("navigation-button--active");
    const remove_class_on_scroll = () => navigatorButton.classList.remove("navigation-button--active");
